...
public class GeneralLedgerTests : IDisposable
{
    ...
    public GeneralLedgerTests()
    {
        ...
        _cashAccount = _f.CreateAccount(_fiscalYear.Id, "1910", "Kassa", incomingBalance: 5000m);
    ...
    public async Task GeneralLedger_WithIBAndTransactions_ReturnsCorrectSections()
    {
        ...
        var sections = await _f.JournalEntryService.GetGeneralLedgerAsync(_fiscalYear.Id);
    ...
    public async Task GeneralLedger_AccountRangeFilter_ReturnsOnlyMatchingAccounts()
    {
        ...
        var sections = await _f.JournalEntryService.GetGeneralLedgerAsync(_fiscalYear.Id, fromAccount: "1000", toAccount: "1999");
