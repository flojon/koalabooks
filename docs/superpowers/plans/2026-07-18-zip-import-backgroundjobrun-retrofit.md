...
No commit for this task (verification only) — if Steps 1–3 reveal a regression, go back to the relevant task, fix it there, and re-run this task's verification from Step 1.
