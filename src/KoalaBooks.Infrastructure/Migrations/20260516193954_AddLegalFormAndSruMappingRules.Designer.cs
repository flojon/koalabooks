...
namespace KoalaBooks.Infrastructure.Migrations
{
    ...
    [Migration("20260516193954_AddLegalFormAndSruMappingRules")]
    partial class AddLegalFormAndSruMappingRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KoalaBooks.Domain.Entities.SruMappingRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AccountPatterns")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<int>("SruCode")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("LegalForm", "SruCode")
                        .IsUnique();

                    b.ToTable("SruMappingRules");
                });
